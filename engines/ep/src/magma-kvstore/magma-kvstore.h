...
/**
 * Experimental Magma KVStore implementation
 *
 */
...
public:
    ...
    RollbackResult rollback(uint16_t vbid,
        ...
        // TODO vmx 2016-10-29: implement
        // NOTE vmx 2016-10-29: For LevelDB/Magma it will probably
	...
	/*
    std::unique_ptr<MagmaKVStore> makeReadOnlyStore() {
        // Not using make_unique due to the private constructor we're calling
        return std::unique_ptr<MagmaKVStore>(
                new MagmaKVStore(configuration));
    }
	*/
...
private:
     ...
     */
    const KVMagma& openDB(uint16_t vbid);
